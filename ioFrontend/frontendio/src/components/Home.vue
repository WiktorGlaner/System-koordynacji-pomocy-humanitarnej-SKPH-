...
const tiles = ref([
  { id: 1, title: t('home-raports'), description: t('home-raports-description'), icon: "fas fa-file-alt", link: "/reports", roles: ["ROLE_AUTHORITY", "ROLE_DONOR", "ROLE_ORGANIZATION"] },
  ...
  { id: 9, title: t('home-tasks'), description: t('home-tasks-description'), icon: "fas fa-map", link: "/tasks", roles: ["ROLE_ORGANIZATION", "ROLE_VOLUNTEER"] },
  { id: 10, title: t('home-requests'), description: t('home-requests-description'), icon: "fas fa-map", link: "/request", roles: ["ROLE_VICTIM", "ROLE_AUTHORITY"] },
]);
